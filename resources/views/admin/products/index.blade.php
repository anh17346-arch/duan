...
<div class="max-w-7xl mx-auto px-4 py-8">
  <x-admin.page-header 
    :title="__('app.manage_products')"
    :subtitle="app()->getLocale() === 'en' ? 'Manage all products in the system' : 'Quản lý tất cả sản phẩm trong hệ thống'"
    ...
    :breadcrumbs="[
      ['title' => __('app.dashboard'), 'url' => route('admin.dashboard')],
      ['title' => __('app.manage_products')]
    ]"
  >
    <x-slot name="actions">
      <a href="{{ route('admin.products.create') }}" class="admin-btn-success">
